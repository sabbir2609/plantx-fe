    ...
    <main className="min-h-screen bg-base-200">
      <div className="mx-auto flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        <p className="mt-2 max-w-lg text-base">
          Just like plants need the right environment to grow, it seems this
          page isn&apos;t ready to bloom. Let&apos;s guide you back to our
          thriving garden of interior designs.
        </p>
