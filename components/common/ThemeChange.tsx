...
export default function ThemeChange() {
    ...
    return (
        <div title="theme-change" className="dropdown dropdown-end ">
            ...
            <div className='dropdown-content bg-base-200 text-base-content rounded-t-box rounded-b-box top-px max-h-[275px] h-[70vh] w-52 overflow-y-auto shadow-2xl mt-16'>
                {themes.map((value) => (
