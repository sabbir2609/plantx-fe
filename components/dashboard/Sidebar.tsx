...
export default function Sidebar() {
    ...
    const menuItems: Record<string, MenuGroup> = {
        ...
        "Users": {
            ...
            items: {
                "All Users": { title: "All Users", link: "#" },
                "Add User": { title: "Add User", link: "#" },
            }
        },
        "Plants": {
            title: "Plants",
            ...
            items: {
                "All Plants": { title: "All Plants", link: "/admin/plants" },
                "Add Plant": { title: "Add Plant", link: "/admin/plants/create" },
            }
        },
    };
