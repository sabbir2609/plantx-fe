                ...
                {events.map((event) => (
                    <SwiperSlide key={event.id} className="p-2">
                        <Link
                            ...
                            className="flex flex-col md:flex-row justify-center items-center bg-base-300 rounded-sm shadow-sm">
                            <div className="relative w-full md:w-1/2 h-48 shadow-md">
                                <Image
                                    ...
                                    width={300}
                                    height={300}
                                    className="object-cover w-full h-full transition duration-500 ease-in-out hover:scale-105 hover:shadow-lg"
                                />
                            </div>
