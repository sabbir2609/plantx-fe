    ...
    return (
        <div className="relative overflow-hidden">
            ...
            <div className="relative z-10 mx-auto p-4 lg:p-8">
                <h1 className="mb-6 text-center text-3xl font-bold text-nowrap">
                    Why Choose Us
                </h1>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {WhyChooseUs.map((item, index) => (
                        <AnimatedSection key={index} delay={index * 0.1}>
                            <div className="flex flex-col p-6 rounded-lg shadow-sm h-full bg-base-300">
                                ...
                                <p className="font-normal text-lg leading-relaxed flex-grow">
                                    {item.description}
                                </p>
                            </div>
                        </AnimatedSection>
