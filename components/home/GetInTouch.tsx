...
export default function GetInTouch() {
    return (
        <div className="px-4 py-8 mx-auto max-w-7xl">
            <h1 className="mb-6 text-4xl font-bold text-center uppercase transition-all duration-300 hover:text-green-500 hover:scale-105">
                Let&apos;s Get Started
            </h1>
            <div className="grid grid-cols-1 lg:gap-6 md:grid-cols-2 lg:grid-cols-3">
                {sections.map((section, index) => (
                    <div key={index} className="relative group overflow-hidden px-6 pt-10 pb-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl rounded-lg">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="p-2 text-center">
                                ...
                                <p className="text-base leading-7 group-hover:text-primary transition-all duration-300">{section.description}
...
// alternate design for GetInTouch.tsx
...
//             <h1 className="mb-8 text-4xl font-bold text-center uppercase">Let&apos;s Get Started</h1>
//             <div className="grid grid-cols-1 lg:gap-6 md:grid-cols-2 lg:grid-cols-3 group">
//                 {sections.map((section, index) => (
//                     <div key={index} className="relative group-hover:blur-sm hover:!blur-none overflow-hidden px-6 pt-10 pb-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl rounded-lg">
//                         <span className="absolute top-0 z-0 h-20 w-20 rounded-full bg-gradient-to-r from-yellow-400 via-pink-500 to-green-600 opacity-0 transition-all duration-500 group-hover:scale-[10] group-hover:opacity-30 group-hover:blur-lg"></span>
//                         <div className="relative z-10">
//                             <Image
//                                 src={section.imgSrc}
//                                 alt={section.imgAlt}
...
//                             />
//                             <div className="p-2 text-center">
//                                 <h2 className="mb-2 text-2xl font-semibold group-hover:text-white/90 transition-colors">{section.title}</h2>
//                                 <p className="text-base leading-7 transition-all duration-300">{section.description}</p>
//                             </div>
//                         </div>
//                     </div>
//                 ))}
