export default function ContactUs() {
    return (
        <div className="flex flex-col md:flex-row w-full h-screen p-5">
            ...
            {/* Contact Information */}
            <div className="w-full md:w-1/2 flex flex-col justify-center rounded-lg shadow-lg p-2">
            ...
            {/* Google Map */}
            <div className="w-full md:w-1/2 mt-10 md:mt-0 md:ml-10 h-96 md:h-full">
                <iframe
